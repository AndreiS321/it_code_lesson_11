...
urlpatterns = [
    ...
    path("customers/list", core.views.CustomerList.as_view(), name="customers_list"),
    ...
    path("sellers/list", core.views.SellerList.as_view(), name="sellers_list"),
    ...
    path("items/list", core.views.ItemList.as_view(), name="items_list"),
    ...
    path("orders/list", core.views.OrderList.as_view(), name="orders_list"),
